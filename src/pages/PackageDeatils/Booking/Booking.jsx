                    ...
                    <form className="card-body">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input disabled type="text" id="image" name="image" defaultValue={user?.displayName} className="w-full px-3 py-2 border rounded-md" />
                            </div>
                            <div>
                                <label htmlFor="food_name" className="block mb-2">Tourist Email</label>
                                <input disabled type="text" id="food_name" name="food_name" defaultValue={user?.email} className="w-full px-3 py-2 border rounded-md" required />
                            </div>
                            <div>
                                <label htmlFor="food_quantity" className="block mb-2">Tourist Image URL</label>
                                <input disabled type="text" id="food_quantity" name="food_quantity" defaultValue={user?.photoURL} className="w-full px-3 py-2 border rounded-md" required />
                            </div>
                            <div>
